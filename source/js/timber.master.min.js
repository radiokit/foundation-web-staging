...
*	Version: 1.0.9
*/
$(document).ready(function(){"use strict";var e=".header",i=".header-animated",o=".header-sticky",a=".header-background",t=".header-compact",n=".header-in",s=".header-out",r=".header-positioned",l="#bkg-retina-img, #retina-img, [data-2x]",d=".equalize",c=".fullscreen-sections-wrapper",h=".fullscreen-section",u=".scroll-link",f=1e3,p="easeInOutQuart",g=.6,m=".grid-container",v=".grid-item, .masonry-stamp",w=".grid-filter-menu",y="0.7s",C="0.7s",x=!1,b=[".video-container iframe",".video-container object"],S=["www.youtube.com","player.vimeo.com"],T=".mejs-container audio, .mejs-container video",z=".carousel-slider",k=".content-slider",P=".tm-slider-container.fullscreen",O=".full-width-slider",A=".logo-slider",M=".hero-slider",H=".testimonial-slider",I=".previous-testimonial-slider",F=".next-testimonial-slider",E=".team-slider",L=".previous-team-slider",W=".next-team-slider",D=".portfolio-recent-slider",V=".previous-portfolio-recent-slider",j=".next-portfolio-recent-slider",q="#tm-lightbox",Q=".lightbox-link",R=".form-element",_=".form-response",N=".form-honeypot",B=".form-submit",U=".signup-form",Z=".required-field",Y="Please wait.",G="Sending...",X="You have been added to our list!",J="Oh boy an error occurred, please try again.",K="Please fill out required fields.",ei="Please enter a valid email address.",ii=".contact-form",oi=".required-field",ai="Please wait.",ti="Sending...",ni="Thank you, your email has been received!",si="Oh boy an error occurred, please try again.",ri="Please fill out required fields.",li="Please enter a valid email address.",di=".map-container",ci=["images/assets/map-marker.png","images/assets/map-marker-2.png"],hi=[[40.723301,-74.002988],[40.691052,-73.925457]],ui=["Downtown New York Office<br>44 St. West 32","The Brooklyn Office<br>East Village 55th St."],fi=45,pi=53,gi=12,mi=!1,vi=!1,$i=!1,wi=!0,yi=!0,Ci=!1,xi=!0,bi=!0,Si="body",Ti=".fade-location, .logo a, .footer-logo a, .navigation a, .side-navigation a, .overlay-navigation a, .grid .overlay-link, .post-media .overlay-link, .post-title a, .post-read-more a, .pagination-previous, .pagination-next",zi=".no-page-fade, .mail-link, .lightbox-link, .contains-sub-menu, .blog .pagination-previous, .blog .pagination-next, .disabled, .scroll-link, .navigation-show a, a.navigation-show",ki="webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",Pi={init:function(){Pi.siteHeader(),Pi.retinize(),Pi.equalize(768),Pi.parallax(".parallax.fixed-height",!0,!1,!0),Pi.parallax(".parallax.fullscreen",!0,!0,!0),Pi.fullScreenSection(),Pi.masonry(),Pi.logoSlider(),Pi.heroSlider(),Pi.testimonialSlider(),Pi.teamSlider(),Pi.portfolioSlider(),Pi.carouselSlider(),Pi.contentSlider(),Pi.fullScreenSlider(),Pi.fullWidthSlider(),Pi.lightbox(),Pi.counter(".stat",".stat-counter",!1),Pi.horizon(".horizon",".parallax .horizon","easeInOutQuint",!1,1),Pi.videos(),Pi.mediaElement(),Pi.signupForm(),Pi.contactForm(),Pi.enablePlaceHolder(),document.getElementById("map-canvas")&&google.maps.event.addDomListener(window,"load",Pi.googleMap),Pi.pageFade(),Pi.scrollToSection()},retinize:function(){$(l).retinizeImages()},equalize:function(e){imagesLoaded($(d),function(){$(d).equalizeHeights({clearUnder:e})})},parallax:function(e,i,o,a){$(e).snowBridge({scaleContainer:i,scaleUnder:960,scaleMinHeight:400,fullscreen:o,fadeInOut:a,fadeThreshold:.5,retinaSupport:!1,parallaxFactor:.6,onLoaded:function(){Pi.horizon(".horizon","","easeInOutQuint",!1,1)}})},horizon:function(e,i,o,a,t){$(e).not(i).horizon({easing:o,recurring:a,threshold:t})},counter:function(e,i,o){$(i).counter({autoStart:!1}),$(e).each(function(){var e=$(this);e.horizon({recurring:o,inView:function(){return e.find(i).data("counting")?!1:void e.find(i).each(function(){e.find(i).data("counting",!0);var o=$(this).data("counter");o.startCounter()})},outOfView:function(){return o&&e.find(i).data("counting")?void e.find(i).each(function(){e.find(i).data("counting",!1);var o=$(this).data("counter");o.clearCounter()}):!1}})})},carouselSlider:function(){$(z).avalancheSlider({animation:"slide",easing:"easeInOutQuart",speed:700,autoAdvance:!1,forceFit:!1,scaleMinHeight:"auto",carousel:!0,carouselVisible:3,lazyLoad:!1,navArrows:!1,navPagination:!0,navShowOnHover:!1,retinaSupport:!1})},contentSlider:function(){$(k).avalancheSlider({animation:"slide",easing:"easeInOutQuart",speed:700,autoAdvance:!1,forceFit:!1,scaleMinHeight:"auto",lazyLoad:!0,navArrows:!0,navPagination:!0,navShowOnHover:!1,retinaSupport:!1})},fullScreenSlider:function(){$(P).avalancheSlider({animation:"slide",easing:"easeInOutQuart",speed:700,autoAdvance:!1,fullscreen:!0,captionScaling:!1,lazyLoad:!0,navArrows:!0,navPagination:!0,navShowOnHover:!0,respectRatio:!1,retinaSupport:!1})},fullWidthSlider:function(){$(O).avalancheSlider({animation:"slide",easing:"easeInOutQuart",speed:700,autoAdvance:!1,forceFit:!1,fullwidth:!0,scaleUnder:960,scaleMinHeight:400,captionScaling:!0,lazyLoad:!0,navArrows:!0,navPagination:!0,navShowOnHover:!0,respectRatio:!1,retinaSupport:!1})},logoSlider:function(){$(A).avalancheSlider({animation:"slide",easing:"easeInOutQuart",speed:700,autoAdvance:!0,carousel:!0,carouselVisible:5,carouselScaleHeight:!0,navArrows:!1,navPagination:!0,showProgressBar:!1,navShowOnHover:!1,retinaSupport:!1})},heroSlider:function(){$(M).avalancheSlider({animation:"slide",easing:"easeInOutQuart",speed:700,autoAdvance:!1,carousel:!0,carouselVisible:1,captionScaling:!1,forceFit:!0,scaleUnder:480,scaleMinHeight:480,fullwidth:!0,navArrows:!1,navPagination:!0,retinaSupport:!0})},testimonialSlider:function(){$(H).avalancheSlider({animation:"slide",easing:"easeInOutQuart",speed:900,autoAdvance:!1,scaleMinHeight:"auto",carousel:!0,carouselVisible:1,carouselScaleHeight:!0,lazyLoad:!1,navArrows:!1,navPagination:!0,navShowOnHover:!1,retinaSupport:!1});var e=$(H).data("avalancheSlider");$(I).on("click",function(i){i.preventDefault(),e.prevSlide()}),$(F).on("click",function(i){i.preventDefault(),e.nextSlide()})},teamSlider:function(){$(E).avalancheSlider({animation:"slide",easing:"easeInOutQuart",speed:900,autoAdvance:!1,carousel:!0,carouselVisible:3,carouselScaleHeight:!0,lazyLoad:!1,navArrows:!1,navPagination:!0,navShowOnHover:!1,retinaSupport:!1});var e=$(E).data("avalancheSlider");$(L).on("click",function(i){i.preventDefault(),e.prevSlide()}),$(W).on("click",function(i){i.preventDefault(),e.nextSlide()})},portfolioSlider:function(){$(D).avalancheSlider({animation:"slide",easing:"easeInOutQuart",speed:900,autoAdvance:!1,carousel:!0,carouselVisible:3,carouselScaleHeight:!0,lazyLoad:!0,navArrows:!1,navPagination:!1,navShowOnHover:!1,retinaSupport:!1});var e=$(D).data("avalancheSlider");$(V).on("click",function(i){i.preventDefault(),e.prevSlide()}),$(j).on("click",function(i){i.preventDefault(),e.nextSlide()})},lightbox:function(){$(Q).summitLightbox({lightboxAnimation:"slideInTop",contentAnimation:"slide",slideAmount:100,easing:"swing",speed:350,onLoaded:function(){var e=$(q).find(".tml-aux-exit");if(0===e.length)return!1;var i=$(Q).data("summitLightbox");e.on("click",function(e){e.preventDefault(),$(this).css({transition:"none"}),i.destroyLightbox()})}})},videos:function(){fluidvids.init({selector:b,players:S})},mediaElement:function(){$(T).each(function(){var e=!1;$(this).is("audio")&&(e=!0),$(this).mediaelementplayer({features:e?["playpause","progress","volume","fullscreen"]:["playpause","progress","current","duration","tracks","volume","fullscreen"],videoWidth:"100%",videoHeight:"100%",audioWidth:"100%",videoVolume:"vertical",audioVolume:"horizontal"})})},siteHeader:function(){function l(){d=$(window).width(),c=$(window).height(),h=Math.ceil(C.outerHeight()),u="window-height"===C.data("bkg-threshold")?c-h:C.data("bkg-threshold"),f="window-height"===C.data("compact-threshold")?c-h:C.data("compact-threshold"),p="window-height"===C.data("sticky-threshold")?c-h:C.data("sticky-threshold"),g=C.data("helper-in-threshold"),m=C.data("helper-out-threshold")}var d,c,h,u,f,p,g,m,v,w=0,y=960,C=$(e),x=C.is("[data-sticky-threshold]")?!0:!1;i=i.split(".").join(""),o=o.split(".").join(""),a=a.split(".").join(""),t=t.split(".").join(""),n=n.split(".").join(""),s=s.split(".").join(""),r=r.split(".").join("");var b=function(i){return $("body").hasClass("mobile")||y>d?!1:(p&&$(i).scrollTop()>=p||0===p?($(e).addClass(o),g&&m&&$(e).addClass(r)):($(e).removeClass(o),g&&m&&$(e).removeClass(r)),u&&$(i).scrollTop()>=u?$(e).addClass(a):$(e).removeClass(a),f&&$(i).scrollTop()>=f?$(e).addClass(t):$(e).removeClass(t),v=$(i).scrollTop(),v>w?(g&&$(i).scrollTop()>=g&&$(e).addClass(n),$(e).removeClass(s)):w>v&&(g&&$(i).scrollTop()<=g&&($(e).removeClass(n),$(e).removeClass(s)),!g||$(i).scrollTop()<g||$(i).scrollTop()>m||($(e).addClass(s),$(s).on(ki,function(o){return o.stopPropagation(),o.target!==$(i)[0]?!1:void $(e).removeClass(s)}))),void(w=v))},S=function(){return l(),$("body").hasClass("mobile")?!1:(d>y&&x&&C.css({height:C.outerHeight()+"px"}),d>y&&$(window).scrollTop()>=p?($(e).addClass(o),g&&m&&$(e).addClass(r)):($(e).removeClass(o),g&&m&&$(e).removeClass(r)),d>y&&$(window).scrollTop()<u?$(e).removeClass(a):d>y&&$(window).scrollTop()>u&&$(e).addClass(a),d>y&&$(window).scrollTop()<f?$(e).removeClass(t):d>y&&$(window).scrollTop()>f&&$(e).addClass(t),void(y>d&&$(e).removeClass(t)))};$(window).on("scroll",function(){b($(this))}),$(window).on("resize",function(){S()}),$("body").hasClass("mobile")||$(window).one("load",function(){l(),b($(this)),d>y&&x&&C.css({height:h+"px"}),$(e).addClass(i)})},fullScreenSection:function(){var e=function(){var e;if($(c).find(h).length>1){if($("body").hasClass("mobile"))return!1;var i,o=$(c).hasClass("no-navigation")?!1:!0;if(o){i=$("<div>").addClass("fs-pagination").appendTo($(c));for(var a=1;a<$(c).children().length;a++)e=$(c).children().eq(a-1).attr("id"),$(c).find("#"+e).data("index",a),$(c).find(i).append('<a href="#'+e+'" id="fs-pagination-'+a+'" data-index="'+a+'" class="fs-bullet-nav" />');$(window).on("resize",function(){t()});var t=function(){$(i).css({marginTop:-$(i).outerHeight()/2+"px",opacity:1})};t();var n=$(c).find(".fs-bullet-nav");n.each(function(){$(this).on("click",function(i){if(i.preventDefault(),$(this).hasClass("active"))return!1;parseFloat($(this).data("index"));e=$(this).attr("href"),Pi.scrollPage(e,0)})})}$(window).on("scroll",function(){$(c).find(h).each(function(){s($(this))})});var s=function(e){e.data("fs-scrolling")||(window.requestAnimationFrame(function(){r(e)}),e.data("fs-scrolling",!0))},r=function(e){if(Pi.isElementVisible(e,g)&&o){$(i).css({opacity:1});var a=$(c).find(e).data("index");i.find(".active").removeClass("active"),i.find("#fs-pagination-"+a).addClass("active"),e.hasClass("nav-dark")?i.addClass("nav-dark"):i.removeClass("nav-dark")}$(i).css(o&&Pi.isElementVisible($(c),g)?{opacity:1,visibility:"visible"}:{opacity:0,visibility:"hidden"}),e.data("fs-scrolling",!1)};$(c).find(h).each(function(){s($(this))})}},i=function(){$(h).each(function(){var e=$(this),i=e.find(".background-image, .background-slider-wrapper");if($(this).is("[data-width],[data-height]"))if($("body").hasClass("mobile")||768>=o){e.addClass("fs-image-scale content-below-on-mobile");var t=e.data("width"),n=e.data("height"),s=e.data("min-height"),r=e.width(),l=n>t?n/t:t/n,d=n>t?r*l:r/l;d=s&&s>=d?s:d,e.css({height:"auto"}),i.css({height:d+"px",minHeight:d+"px"})}else e.removeClass("fs-image-scale"),e.css({height:""}),i.css({height:"",minHeight:""});else $("body").hasClass("mobile")||768>=o?i.css({height:a+"px"}):(e.removeClass("fs-image-scale"),e.css({height:""}),i.css({height:"",minHeight:""}))})},o=$(window).width(),a=$(window).height();$(window).on("resize",function(){o=$(window).width(),a=$(this).height(),i()}).resize(),e()},scrollToSection:function(){var e=[];$(u).each(function(){e.push($(this).attr("href")),$(this).on("click",function(e){e.preventDefault();var i=$(this).attr("href"),o=$(this).data("offset")?$(this).data("offset"):0;Pi.scrollPage(i,o)})}),$(window).one("load",function(){$.each(e,function(e,o){i($(o))})}),$(window).on("scroll",function(){$.each(e,function(e,o){i($(o))})});var i=function(e){e.data("section-scrolling")||(window.requestAnimationFrame(function(){o(e)}),e.data("section-scrolling",!0))},o=function(e){if(Pi.isElementVisible(e,g)){var i=e.attr("id"),o=$('a[href="#'+i+'"]').closest("header, .side-navigation-wrapper, .overlay-navigation-wrapper");o&&($('a[href="#'+i+'"]').closest("header, .side-navigation-wrapper, .overlay-navigation-wrapper").find(u).parent().removeClass("current"),$('a[href="#'+i+'"]').parent().addClass("current"))}e.data("section-scrolling",!1)}},isElementVisible:function(e,i){if(i=e.is("[data-visible-threshold]")?e.data("visible-threshold"):g,void 0===e.offset())return console.log("template-functions.js@isElementVisible: "+e.selector+" cannot be found in your html page."),!1;var o=$(window).height(),a=$(window).scrollTop(),t=a+$(window).height(),n=e.offset().top,s=(e.height(),n+e.outerHeight()-o*i),r=n+o*i;return e.is($(c))||(r>t||a>s?e.removeClass("in-view"):e.addClass("in-view")),t>=r&&s>=a},scrollPage:function(e,i){$("html, body").animate({scrollTop:$(e).offset().top+i},f,p)},masonry:function(){$(m).each(function(){var e,i,o=$(this),a=$(this).find(".grid");if(o.data("layout-mode")){e=o.data("layout-mode")?o.data("layout-mode"):"masonry",o.is("[data-layout-mode]")&&o.addClass("masonry"),o.is("[data-set-dimensions]")&&o.addClass("masonry-set-dimensions"),x=o.is("[data-animate-resize]")?!0:!1,C=o.is("[data-animate-resize-duration]")?o.data("animate-resize-duration")+"s":C,o.is(".masonry-set-dimensions, .masonry-set-dimensions-2")?(o.is(".full-width.no-margins")&&Pi.masonryWrapperWidth(o,a),i=Pi.masonryColWidth(o,a),Pi.masonryThumbSizes(o,a,Pi.masonryColWidth(o,a))):i=".grid-sizer";var t=$('<div class="tm-loader"><div id="circle" /></div>');t.appendTo(o),imagesLoaded(a,function(){a.isotope({filter:"*",itemSelector:".grid-item",isResizeBound:x?!0:!1,transitionDuration:y,layoutMode:e,stamp:".masonry-stamp",masonry:{columnWidth:i}}),o.find(t).remove(),a.css({visibility:"visible",minHeight:"initial"});var n=a.children().length-1;$("body").hasClass("transition-support")||o.removeClass("fade-in-progressively"),a.children().each(function(e){$(this).delay(100*e).animate({opacity:1},500,"easeInOutQuart",function(){e===n&&o.removeClass("fade-in-progressively")})}),$(window).on("resize",function(){o.is(".full-width.no-margins")&&Pi.masonryWrapperWidth(o,a),Pi.masonryThumbSizes(o,a,Pi.masonryColWidth(o,a)),x?a.isotope({transitionDuration:C,masonry:{columnWidth:".grid-sizer"!==i?Pi.masonryColWidth(o,a):".grid-sizer"}}):(a.removeClass("filtering"),a.isotope({transitionDuration:0,masonry:{columnWidth:".grid-sizer"!==i?Pi.masonryColWidth(o,a):".grid-sizer"}}).isotope("layout").isotope({transitionDuration:C}))})})}else a.css({visibility:"visible"})}),$(w).each(function(){$(this).find("a").on("click",function(e){e.preventDefault(),$(this).closest(w).find(".active").removeClass("active"),$(this).addClass("active");var i=$(this).closest(w).data("target-grid")?$(this).closest(w).data("target-grid"):m;i=$(i).find(".grid"),y=i.is("[data-animate-filter-duration]")?i.data("animate-filter-duration")+"s":y,i.isotope({transitionDuration:y});var o=$(this).attr("data-filter");$(i).addClass("filtering").isotope({filter:o})})})},masonryWrapperWidth:function(e,i){var o=Math.ceil(1.001*e.width());i.css({maxWidth:o+"px",width:o+"px"})},masonryColWidth:function(e,i){var o,a=$(window).width(),t=Math.ceil(e.width()),n=e.is(".full-width.no-margins")?Math.ceil(1.001*t):i.width();return e.is(".full-width.small-margins, .full-width.no-margins")?(i.hasClass("content-grid-2")&&(o=480>a?n/1:n/2),i.hasClass("content-grid-3")&&(o=a>768?n/3:768>=a&&a>480?n/2:n/1),i.hasClass("content-grid-4")&&(o=a>1140?n/4:1140>=a&&a>768?n/3:768>=a&&a>480?n/2:n/1),i.hasClass("content-grid-5")&&(o=a>1300?n/5:1300>=a&&a>1140?n/4:a>1140||768>a?768>=a&&a>480?n/2:n/1:n/3),i.hasClass("content-grid-6")&&(o=a>1300?n/6:1300>=a&&a>1140?n/4:a>1140||768>a?768>=a&&a>480?n/2:n/1:n/3)):(i.hasClass("content-grid-2")&&(o=600>a?n/1:n/2),i.hasClass("content-grid-3")&&(o=a>960?n/3:960>=a&&a>600?n/2:n/1),i.hasClass("content-grid-4")&&(o=a>1140?n/4:1140>=a&&a>960?n/3:960>=a&&a>600?n/2:n/1),i.hasClass("content-grid-5")&&(o=a>1300?n/5:1300>=a&&a>1140?n/4:1140>=a&&a>960?n/3:960>=a&&a>600?n/2:n/1),i.hasClass("content-grid-6")&&(o=a>1300?n/6:1300>=a&&a>1140?n/4:1140>=a&&a>960?n/3:960>=a&&a>600?n/2:n/1)),o=Math.floor(o)},masonryThumbSizes:function(e,i,o){var a,t=$(window).width(),n=2,s=$(".masonry-set-dimensions").hasClass("no-margins")?0:parseFloat(i.find(".grid-item").css("padding-left")),r=e.is(".masonry-set-dimensions")?e.is("[data-grid-ratio]")?parseFloat(e.data("grid-ratio")):1.5:1;if(a=Math.floor((o-s)/r+s),e.is(".masonry-set-dimensions")){var l=e.is(".full-width.small-margins, .full-width.no-margins")?480:600;i.find(v).each(function(){$(this).css($(this).is(".large, .masonry-stamp.large")?$(this).is(".portrait, .masonry-stamp.portrait")?{width:t>l?Math.floor(o*n)+"px":o+"px",height:t>l?Math.floor(2*a*n)+"px":2*a+"px"}:{width:t>l?Math.floor(o*n)+"px":o+"px",height:t>l?Math.floor(a*n)+"px":a+"px"}:$(this).is(".wide, .masonry-stamp.wide")?{width:t>l?Math.floor(o*n)+"px":o+"px",height:t>l?a+"px":a/2+"px"}:$(this).is(".portrait, .masonry-stamp.portrait")?{width:o+"px",height:Math.floor(a*n)+"px"}:{width:o+"px",height:a+"px"})})}e.is(".masonry-set-dimensions-2")&&i.find(v).each(t>600?function(){$(this).hasClass("horizontal")?$(this).hasClass("two-third")?$(this).children(".item-description").length?$(this).css({width:Math.floor(o*(n+1))+"px",height:Math.floor(a)+"px"}):$(this).addClass("no-description").css({width:Math.floor(o*n)+"px",height:Math.floor(a)+"px"}):$(this).css({width:Math.floor(o*n)+"px",height:Math.floor(a)+"px"}):$(this).css($(this).hasClass("vertical")?$(this).hasClass("two-third")?$(this).children(".item-description").length?{width:o+"px",height:Math.floor(o*(n+1))+"px"}:{width:o+"px",height:Math.floor(a*n)+"px"}:{width:o+"px",height:Math.floor(a*n)+"px"}:{width:o+"px",height:Math.floor(a)+"px"})}:function(){$(this).css($(this).find("iframe, video, .tm-slider-container").length?{width:o+"px",height:a+"px"}:{width:"",height:""})})},signupForm:function(){$(U).submit(function(e){e.preventDefault();var i=$(this),o=i.parent().find(_),a=i.find(R),t=i.find('input[type="email"]'),n=i.find(N),s=i.find(B),r=i.attr("action"),l=i.attr("method"),d=i.serialize(),c=!1,h=!1,u=!1;if(Z=Z.split(".").join(""),a.removeClass(Z),a.each(function(){$(this).attr("required")&&($(this).val()||(c=!0,$(this).addClass(Z),o.hide().text(K).fadeIn(200)))}),c||(h=!0),t.val()&&!Pi.isValidEmail(t.val())?(o.hide().text(ei).fadeIn(200),t.addClass(Z)):u=!0,""!==n.val())return!1;if(c&&t.val()&&!Pi.isValidEmail(t.val())&&o.hide().text(K+" "+ei).fadeIn(200),h&&u){var f=$(s).val();$(s).css({width:$(s).outerWidth()+"px"}).val(G).attr("disabled",!0),o.hide().text(Y).fadeIn(200),$.ajax({url:r,type:l,data:d,dataType:"json"}).done(function(e){try{e.response===!0?(o.text(X),o.delay(1500).fadeOut(200),a.val("")):o.hide().text(e.json.error_message).fadeIn(200)}catch(i){console.log("error in parsing returned ajax data: "+i),o.hide().text("Error occurred. Please see the console for details.").fadeIn(200)}}).fail(function(e,i,a){console.log("Error occured in processing your request:"),console.log(e),console.log("Text status"),console.log(i),console.log("Error thrown"),console.log(a),console.log("Servre response"),console.log(e.status),console.log("Response Text may contain error output from PHP"),console.log(e.responseText),o.hide().text(J+i+" ("+a+")").fadeIn(200)}).always(function(){$(s).css({width:""}).val(f).attr("disabled",!1)})}})},contactForm:function(){$(ii).submit(function(e){e.preventDefault();var i=$(this),o=i.parent().find(_),a=i.find(R),t=i.find('input[type="email"]'),n=i.find(N),s=i.find(B),r=i.attr("action"),l=i.attr("method"),d=i.serialize(),c=!1,h=!1,u=!1;if(oi=oi.split(".").join(""),a.removeClass(oi),a.each(function(){$(this).attr("required")&&($(this).val()||(c=!0,$(this).addClass(oi),o.hide().text(ri).fadeIn(200)))}),c||(h=!0),t.val()&&!Pi.isValidEmail(t.val())?(o.hide().text(li).fadeIn(200),t.addClass(oi)):u=!0,""!==n.val())return!1;if(c&&t.val()&&!Pi.isValidEmail(t.val())&&o.hide().text(ri+" "+li).fadeIn(200),h&&u){var f=$(s).val();$(s).css({width:$(s).outerWidth()+"px"}).val(ti).attr("disabled",!0),o.hide().text(ai).fadeIn(200),$.ajax({url:r,type:l,data:d,dataType:"json"}).done(function(e){try{if(e.response===!0)o.text(ni),o.delay(1500).fadeOut(200),a.val("");else{var i=void 0===e.json.error_message?"There is a possibility that your message was not sent. Please check up the server or script configuration.":e.json.error_message;o.hide().text(si+" "+i).fadeIn(200)}}catch(t){console.log("error in parsing returned ajax data: "+t),console.log(e),o.hide().text("Error occurred. Please see the console for details.").fadeIn(200)}}).fail(function(e,i,a){console.log("Error occured in processing your request:"),console.log(e),console.log("Text status"),console.log(i),console.log("Error thrown"),console.log(a),console.log("Servre response"),console.log(e.status),console.log("Response Text may contain error output from PHP"),console.log(qXHR.responseText),o.hide().text(si+" (Please see the console for error details.)").fadeIn(200)}).always(function(){$(s).css({width:""}).val(f).attr("disabled",!1)})}})},isValidEmail:function(e){var i=RegExp(/^[_\.0-9a-zA-Z-]+@([0-9a-zA-Z][0-9a-zA-Z-]+\.)+[a-zA-Z]{2,6}$/i);return i.test(e)},enablePlaceHolder:function(){$("input, textarea").placeholder()},googleMap:function(){ci=$(di).data("icon")?JSON.parse("["+$(di).data("icon")+"]"):ci,hi=$(di).data("coordinates")?$(di).data("coordinates"):hi,ui=$(di).data("info")?JSON.parse("["+$(di).data("info")+"]"):ui,gi=$(di).data("zoom-level")?parseFloat($(di).data("zoom-level")):gi,xi=$(di).data("style")&&"greyscale"===$(di).data("style")?!0:!1;for(var e,i,o=xi?-100:0,a=$("body").hasClass("mobile")?!1:!0,t={draggable:a,zoom:gi,center:new google.maps.LatLng(hi[0][0],hi[0][1]),mapTypeControl:vi,mapTypeControlOptions:{style:google.maps.MapTypeControlStyle.DROPDOWN_MENU,position:google.maps.ControlPosition.TOP_RIGHT},panControl:$i,panControlOptions:{position:google.maps.ControlPosition.TOP_LEFT},zoomControl:wi,zoomControlOptions:{style:google.maps.ZoomControlStyle.SMALL,position:google.maps.ControlPosition.LEFT_TOP},scrollwheel:mi,scaleControl:yi,streetViewControl:Ci,streetViewControlOptions:{position:google.maps.ControlPosition.LEFT_TOP},styles:[{stylers:[{saturation:o}]}]},n=new google.maps.Map(document.getElementById("map-canvas"),t),s=0,r=0;r<hi.length;r++)e=new google.maps.Marker({position:new google.maps.LatLng(hi[r][0],hi[r][1]),map:n,icon:new google.maps.MarkerImage(ci[s],null,null,null,new google.maps.Size(fi,pi))}),i=new google.maps.InfoWindow({content:ui[r]}),google.maps.event.addListener(e,"click",function(e,o){return function(){i.setContent(ui[o]),i.open(n,e)}}(e,r)),s++;google.maps.event.addDomListener(window,"resize",function(){var e=n.getCenter();google.maps.event.trigger(n,"resize"),n.setCenter(e)})},pageFade:function(){return bi?void $(Ti).not(zi).on("click",function(e){e.preventDefault();var i=this.href;$("body").hasClass("transition-support")?$(Si).addClass("page-fade-out").on(ki,function(e){return e.stopPropagation(),e.target!==$(this)[0]?!1:void Pi.goToNewPage(i)}):Pi.goToNewPage(i)}):!1},goToNewPage:function(e){window.location=e}};!function(){for(var e=0,i=["ms","moz","webkit","o"],o=0;o<i.length&&!window.requestAnimationFrame;++o)window.requestAnimationFrame=window[i[o]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[i[o]+"CancelAnimationFrame"]||window[i[o]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(i){var o=(new Date).getTime(),a=Math.max(0,16-(o-e)),t=window.setTimeout(function(){i(o+a)},a);return e=o+a,t}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(e){clearTimeout(e)})}(),Pi.init()});